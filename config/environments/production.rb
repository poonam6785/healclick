...
Healclick::Application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = 'www.healclick.com'
  ...
  config.action_controller.asset_host = "http://s3.amazonaws.com/healclick-prod"
  ...
  config.action_controller.asset_host = "//s3-us-west-2.amazonaws.com/healclick-prod"
  config.assets.prefix = "/assets"
  ...
  config.action_mailer.smtp_settings = {
    ...
    :user_name            => 'AKIAJD55MR7D6DNOMEQA',
    :password             => 'AnBUYMqCUugMPp8+0wwBpPohye916/Sc8ljecGdrmjx9',
